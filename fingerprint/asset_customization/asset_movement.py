...
# /home/moi-mis/frappe-bench/apps/erpnext/erpnext/assets/doctype/asset_movement/asset_movement.py
...
class AssetMovement(Document):
	...
	def set_latest_location_and_custodian_in_asset(self):
		...
		for d in self.assets:
			...
			frappe.db.set_value("Asset", d.asset, "department", employee_doc.department or "", update_modified=False)
			frappe.db.set_value("Asset", d.asset, "office_name", employee_doc.branch or "", update_modified=False)
			frappe.db.set_value("Asset", d.asset, "custom_employee_name", employee_doc.employee_name, update_modified=False)
